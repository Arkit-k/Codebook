...
<section className="min-h-screen bg-gray-100 dark:bg-black text-gray-900 dark:text-white relative overflow-hidden px-4">
  {/* Background Effects */}
  <div className="max-w-6xl mx-auto relative z-10 md:mt-32 px-4">
    <div className="bg-white dark:bg-stone-800/30 backdrop-blur-lg rounded-3xl p-8 border border-gray-300 dark:border-stone-700/50 relative overflow-hidden">
      {/* Decorative elements */}
